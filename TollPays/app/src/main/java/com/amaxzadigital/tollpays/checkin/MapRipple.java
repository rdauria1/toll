...
/**
 * Created by Hussain Marvi on 12-Apr-17.
 */
...
public class MapRipple {
    ...
    private int fillColor = Color.parseColor("#21904d");           //fillcolor of circle
    private int strokeColor = Color.parseColor("#186938");               //border text of circle
    private int strokewidth = 5;                          //border width of circle
...
//            distance = 200;
    ...
    private void OverLay(final int i) {
        ...
        vAnimators[i].addListener(new AnimatorListenerAdapter() {
            @Override
...
//                handlers[i].removeCallbacks(runnable1);
    ...
    private Bitmap drawableToBitmap(Drawable drawable) {
        ...
        if (drawable.getIntrinsicWidth() <= 0 || drawable.getIntrinsicHeight() <= 0) {
            bitmap = Bitmap.createBitmap(1, 1, Bitmap.Config.ARGB_8888); // Single text bitmap will be created of 1x1 pixel
        } else {
